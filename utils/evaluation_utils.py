...
def compute_independent_mAP(final_results, synset_names, degree_thresholds=[360], shift_thresholds=[100], iou_3d_thresholds=[0.1], iou_pose_thres=0.1, use_matches_for_pose=True):
...
def evaluate(path):
    ...
    result_pkl_list = glob.glob(os.path.join(path, 'results_*.pkl'))
